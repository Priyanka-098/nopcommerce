...
class Test_SearchCustomerbyEmail_TC003:
    ...
    def test_searchCustomerbyEmail(self,setup):
        ...
        self.searchcustbyemail=SearchCustomerPage(self.driver)
        self.searchcustbyemail.setEmail("kiyjcycyhjc676008@gmail.com")
        self.searchcustbyemail.clickSearch()
        status=self.searchcustbyemail.searchCustomerbyEmail("kiyjcycyhjc676008@gmail.com")
        assert True== status
        self.driver.close()
